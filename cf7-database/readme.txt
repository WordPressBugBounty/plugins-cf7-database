...
- [Frontend Demo](http://demo.ninjateam.org/contact-form-7-database)
Fill submission details for testing
- [Backend Demo](http://demo.ninjateam.org/contact-form-7-database/admin) 
Log in WordPress dashboard to view the saved data
Username: `demo`
Password: `demo`

⛩️ [Get Database for Contact Form 7 Pro](https://1.envato.market/Database-CF7)

⛩️ Compare [Free vs Pro](https://ninjateam.org/contact-form-7-database/#pricing)
...
👉 [View documentation](https://ninjateam.gitbook.io/contact-form-7-database)
👉 [Contact us for technical support](https://ninjateam.org/contact-form-7-database/)

= ♥️ Like this Database for Contact Form 7 Plugin? =

- Rate us 5⭐ stars on [WordPress.org](https://wordpress.org/support/plugin/cf7-database/reviews/#new-post).
- Check out our [other Contact Form 7 extensions](https://1.envato.market/Form-Plugins)!

= 💅 Looking for an appointment booking form? =

Try out this free [WordPress appointment booking form plugin](https://wordpress.org/plugins/bookster/) 🌐

###COMPATIBILITY

- This is an extension for Contact Form 7, meaning you have to install and activate Contact Form 7 beforehand.
- This add-on is compatible with all major WordPress themes, plugins and page builders.
- Go perfectly with [Multi-Step for Contact Form 7](https://wordpress.org/plugins/cf7-multi-step/).

###CREDITS

This plugin is inspired by [Contact Form 7](https://wordpress.org/plugins/contact-form-7/) by Takayuki Miyoshi.
...
Yes, with the free version, you are allowed to save 1 form to the database, including all fields and professional options. Should you have multiple forms and you want to save them all, don't hesitate to upgrade to the [CF7 Database pro version](https://1.envato.market/Database-CF7). It's a big time-saver. And you **pay once** to use it forever.
...
Additionally, you can check out our plugin [GDPR Compliance](https://wordpress.org/plugins/ninja-gdpr-compliance/) to help make sure your WordPress site is GDPR-friendly.
...
== Screenshots ==
1. A contact form 7 on the front-end
2. Contact form database in WordPress dashboard
